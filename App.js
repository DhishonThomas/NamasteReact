...
const Title = () => {
  return (
    <a href="/">
      <img alt="logo" className="logo" src="https://yt3.googleusercontent.com/ytc/AIdro_khDPXdl1ezbGnSrhNWw09nCQDdpcWXF8QnV-1xCcbYng=s900-c-k-c0x00ffffff-no-rj"></img>
    </a>
  )
}
...
const RestrauntCard = (props) => {
  ...
  const {name,cuisines,totalRatingsString,deliveryTime,cloudinaryImageId}=props.resObj?.data
  console.log(name)
  return (
    <div className="res-card">
      <img alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}></img>
      <h3>{name}</h3>
      <h4>{cuisines.join(',')}</h4>
